# Generated by Django 5.0.1 on 2024-02-02 05:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_groups', models.ManyToManyField(blank=True, related_name='ecommerce_users', to='auth.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('items', models.ManyToManyField(related_name='orders', to='ecommerce.cartitem')),
